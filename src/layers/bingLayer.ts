...
class BingTileLayer extends L.TileLayer {
  ...
  override getTileUrl(coords: L.Coords): string {
    ...
    if (this.layer === 'sv') {
      ...
      return `https://t.ssl.ak.dynamic.tiles.virtualearth.net/comp/ch/${quadKey}?mkt=zh-cn&ur=cn&it=G,LC,L&jp=1&og=2618&sv=9.33&n=t&dre=1&o=webp,95&cstl=s23&st=bld|v:0`;
    }
  }
}
